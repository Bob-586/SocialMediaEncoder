...
"").replace(/(?:\r\n|\r|\n)/g,"<br>");c=document.getElementById("feed_update_list");d=document.createElement("li");var e="";b[a].hasOwnProperty("ds")&&(e="/"+b[a].ds);if(b[a].hasOwnProperty("id")){var g=window.location.href.replace("index.php","");f+="<br><br>"+("<button onclick='btn_report(\""+b[a].id+"\");'>Report Abuse</button>")+" ** The Shared Link for this message is &nbsp; &nbsp; "+g+b[a].id+e}d.innerHTML=f.trim();c.appendChild(d);d=document.createElement("hr");c.appendChild(d);document.getElementById("pages").style.display=
"block"}})};