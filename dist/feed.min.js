...
d).replace(/(?:\r\n|\r|\n)/g,"<br>"),d=document.getElementById("feed_update_list"),a=document.createElement("li"),a.innerHTML=(c+b).trim(),d.appendChild(a),c=document.createElement("hr"),d.appendChild(c),document.getElementById("btn-abuse").style.display="block"):document.getElementById("wait").innerHTML="No Results Found"}})}
...
"").replace(/(?:\r\n|\r|\n)/g,"<br>");e=document.getElementById("feed_update_list");c=document.createElement("li");var f="";b[d].hasOwnProperty("ds")&&(f="/"+b[d].ds);b[d].hasOwnProperty("id")&&(f="<br><br> ** The Shared Link for this message is &nbsp; &nbsp; "+window.location.href.replace("index.php","")+b[d].id+f,a+="<button onclick='btn_report(\""+b[d].id+"\");'>Report Abuse</button>",a+=f);c.innerHTML=a.trim();e.appendChild(c);c=document.createElement("hr");e.appendChild(c)}})};