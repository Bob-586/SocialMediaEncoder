...
postAjax("do_post.php",{enc:a,pass:b,style:d,tags:e,track:c},function(a){document.getElementById("post").disabled=!1;a=JSON.parse(a);if(a.hasOwnProperty("Failed"))document.getElementById("msg").innerHTML=a.Failed;else if(a.hasOwnProperty("Error"))document.getElementById("msg").innerHTML=a.Error;else if(a.hasOwnProperty("Success")&&a.hasOwnProperty("id")){var b=a.id,c=window.location.href.replace("post.php","").replace("index.php",""),d="";a.hasOwnProperty("ds")&&(d="/"+a.ds);a=a.Success+". Your Link is: "+
c+b+d;document.getElementById("msg").innerHTML=a;document.getElementById("enc").value=""}})}catch(h){"undefined"!=typeof h.message?(console.warn(h.message),alert(h.message)):(console.warn(h),alert(h)),document.getElementById("post").disabled=!1,document.getElementById("msg").innerHTML=""}})}
