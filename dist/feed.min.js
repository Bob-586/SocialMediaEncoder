...
"").replace(/(?:\r\n|\r|\n)/g,"<br>");b=document.getElementById("feed_update_list");c=document.createElement("li");if(e[d].hasOwnProperty("id")){var f="<br><br> ** The Shared Link for this message is &nbsp; &nbsp; "+window.location.href.replace("index.php","")+e[d].id;a+=f}c.innerHTML=a.trim();b.appendChild(c);c=document.createElement("hr");b.appendChild(c)}})};